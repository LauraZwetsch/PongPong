...
// Função da fase2 que começa quando algum jogador atingir 5 pontos
function fase2() {
...
function fase4() {
    if (pointsPlayer1 === 10 || pointsPlayer2 === 10) {
        alert("Fase 2! Agora a bola está mais rápida e menor!")
        bolaSpeedX = 10;
        bolaSpeedY = 10;
...
function fase5() {
    if (pointsPlayer1 === 15 || pointsPlayer2 === 15) {
        alert("Fase 2! Agora a bola está muito mais rápida e menor ainda!")
        bolaSpeedX = 12;
        bolaSpeedY = 12;
